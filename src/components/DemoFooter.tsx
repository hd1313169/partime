...
export const DemoFooter: React.FC = () => {
  ...
  return (
    <footer className="app-shell-wide px-4 sm:px-6 lg:px-8 py-6 border-t border-slate-200">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-base font-normal text-slate-400 text-center sm:text-left">
